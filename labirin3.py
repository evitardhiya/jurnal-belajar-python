...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet('Python Pro/mazegame/bullet.png', self.rect.right, self.rect.centery, 15, 20, 15)
        bullets.add(bullet)
...
w1 = GameSprite('Python Pro/mazegame/platform2.png',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('Python Pro/mazegame/platform2_v.png', 370, 100, 50, 400)
...
final_sprite = GameSprite('Python Pro/mazegame/pac-1.png', win_width - 85, win_height - 100, 80, 80)
monster1 = Enemy('Python Pro/mazegame/cyborg.png', win_width - 80, 150, 80, 80, 5)
monster2 = Enemy('Python Pro/mazegame/cyborg.png', win_width - 80, 230, 80, 80, 5)
...
while run:
    ...
    if not finish:
        ...
        if sprite.spritecollide(packman, monsters, False):
            finish = True
            #calculate the ratio
            img = image.load('Python Pro/mazegame/game-over_1.png')
        ...
        if sprite.collide_rect(packman, final_sprite):
            finish = True
            img = image.load('Python Pro/mazegame/thumb.jpg')
            window.fill((255, 255, 255))
